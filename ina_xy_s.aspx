		...
		<script type="text/javascript">
            ...
            function q_seekStr() {
                ...
                if(t_productno.length>0){
                	t_where+=" and exists (select * from view_inas where noa=view_ina"+r_accy+".noa and productno='"+t_productno+"') ";
                }
                if(t_custno.length>0){
                	t_where+=" and exists (select * from view_inas where noa=view_ina"+r_accy+".noa and sssno='"+t_custno+"') ";
                }
                if(t_cubno.length>0){
                	t_where+=" and exists (select * from view_inas where noa=view_ina"+r_accy+".noa and rc2no='"+t_cubno+"') ";
                }
			...
			<table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
				...
				<tr class='seek_tr'>
					...
					<td>
						...
						<input class="txt" id="txtProduct" type="text" style="width:115px;font-size:medium;" disabled="disabled" />
					</td>
				</tr>
				<tr class='seek_tr'>
					<td class='seek' style="width:20%;"><a id='lblCustno_xy'>客戶編號</a></td>
					<td>
						<input class="txt" id="txtCustno" type="text" style="width:90px; font-size:medium;" />&nbsp;
						<input class="txt" id="txtCust" type="text" style="width:115px;font-size:medium;" disabled="disabled" />
					</td>
				</tr>
				<tr class='seek_tr'>
