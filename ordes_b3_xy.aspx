<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			var q_name = 'view_ordes', t_bbsTag = 'tbbs', t_content = " field=datea,productno,product,spec,dime,width,lengthb,lengthc,unit,mount,weight,notv,noa,no2,price,theory,datea,custno,style,class,uno,total,memo,comp,cuamount,ucahours,stationhours,stationgen,source,sprice,classa", afilter = [], bbsKey = ['noa', 'no2'], as;
			//, t_where = '';
		...
		<div  id="dbbs"  >
			...
			<table id="tbbs" class='tbbs'  border="2"  cellpadding='2' cellspacing='1' style='width:100%'  >
				<tr style='color:White; background:#003366;' >
					...
					<td align="center"><a id='lblProduct'> </a> <a id='lblSpec'> </a></td>
				...
				<tr  style='background:#cad3ff;'>
					...
					<td style="width:15%;">
						...
						<input class="txt" id="txtClassa.*" type="text" style="width:20%;" />
						<input class="txt" id="txtSpec.*" type="text" style="width:75%;" />
					</td>
					<td style="width:4%;"><input class="txt" id="txtUnit.*" type="text" style="width:94%;"/></td>
					<td style="width:8%;"><input class="txt" id="txtLengthb.*" type="text" style="width:96%; text-align:right;"/></td>
					<td style="width:8%;"><input class="txt" id="txtLengthc.*" type="text" style="width:96%; text-align:right;"/></td>
