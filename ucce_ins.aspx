                        ...
                        BEGIN TRY
	                        ...
	                        begin
		                        ...
		                        begin
			                        ...
			                        select @t_noa,CAST(@noq as nvarchar(10)),a.noa,a.product,a.spec,a.style,round(@mount-isnull(c.tmount,0),4),a.unit,0,0,'盤點數量:'+@memo+case when d.noa is not null then ',客戶名稱:'+d.nick else '' end ,isnull(b.mount,0),@t_storeno,isnull(c.tmount,0),@mount
