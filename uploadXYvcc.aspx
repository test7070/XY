	...
	<head>
		...
		<script language="c#" runat="server">
	        ...
	        public void Page_Load()
	        {
	            ...
	            string savepath = "C:\\inetpub\\wwwroot\\doc\\vcc\\";
	                    ...
	                    if (nFileNameStr >= 10)
	                    {
	                        ...
	                        if (filename.Length != 0)
	                        {
	                            try
	                            {
	                                ...
	                                System.IO.FileStream fs = new System.IO.FileStream(savepath + filename.Substring(0, end)+ filename.Substring(end), System.IO.FileMode.OpenOrCreate);
									...
									string vccno = filename.Substring(0, end);
									//資料
						            ...
						            using (System.Data.SqlClient.SqlConnection connSource = new System.Data.SqlClient.SqlConnection(connectionString))
						            {
						                ...
						                connSource.Open();
						                string queryString = @"
											declare @accy nvarchar(20)=isnull((select top 1 accy from view_vcc  where noa = @vccno and isnull(accy,'')!='' order by accy desc),'')
							                if(@accy!='')
												EXEC('update vcc'+@accy+' set zipcode='''+@filename+''' where noa = '''+@vccno+''' ')
										";
						                System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand(queryString, connSource);
						                cmd.Parameters.AddWithValue("@vccno", vccno);
	                                ...
	                                //i = url.IndexOf("?");
	                                //Response.Redirect("uploadXYvcc_post.aspx"+ ( i > 0 ?  url.Substring( i) : ""));   /// 
	                            }
